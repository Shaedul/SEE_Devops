...
public class UploadDBServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/gallery", "root", "");
            PreparedStatement pst = con.prepareStatement("insert into image_data values(?,?,?,?,?)");
            pst.setInt(1, id);
